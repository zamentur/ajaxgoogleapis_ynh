...
function $JSCompiler_StaticMethods_updateClassName$$($e$$15$$, $add_opt_add_remainingClasses$$, $opt_remove_remove$$) {
  ...
  for(var $classes$$ = $e$$15$$.className.split(/\s+/), $i$$6$$ = 0;$i$$6$$ < $add_opt_add_remainingClasses$$.length;$i$$6$$ += 1) {
    for(var $found$$ = $JSCompiler_alias_FALSE$$, $j$$1$$ = 0;$j$$1$$ < $classes$$.length;$j$$1$$ += 1) {
      if($add_opt_add_remainingClasses$$[$i$$6$$] === $classes$$[$j$$1$$]) {
        $found$$ = $JSCompiler_alias_TRUE$$;
        break
      }
    }
    $found$$ || $classes$$.push($add_opt_add_remainingClasses$$[$i$$6$$])
  }
  $add_opt_add_remainingClasses$$ = [];
  for($i$$6$$ = 0;$i$$6$$ < $classes$$.length;$i$$6$$ += 1) {
    $found$$ = $JSCompiler_alias_FALSE$$;
    for($j$$1$$ = 0;$j$$1$$ < $opt_remove_remove$$.length;$j$$1$$ += 1) {
      if($classes$$[$i$$6$$] === $opt_remove_remove$$[$j$$1$$]) {
        $found$$ = $JSCompiler_alias_TRUE$$;
        break
      }
    }
    $found$$ || $add_opt_add_remainingClasses$$.push($classes$$[$i$$6$$])
  }
  $e$$15$$.className = $add_opt_add_remainingClasses$$.join(" ").replace(/\s+/g, " ").replace(/^\s+|\s+$/, "")
}
function $JSCompiler_StaticMethods_hasClassName$$($e$$16$$, $name$$62$$) {
  for(var $classes$$1$$ = $e$$16$$.className.split(/\s+/), $i$$7$$ = 0, $len$$ = $classes$$1$$.length;$i$$7$$ < $len$$;$i$$7$$++) {
    if($classes$$1$$[$i$$7$$] == $name$$62$$) {
...
function $JSCompiler_StaticMethods_getPlatformVersionString_$$($JSCompiler_StaticMethods_getPlatformVersionString_$self_blackBerryVersion$$) {
  ...
  if($genericVersion_iVersion_linuxOrCrOsVersion_parts$$3_winPhoneVersion$$ = $JSCompiler_StaticMethods_getMatchingGroup_$$($JSCompiler_StaticMethods_getPlatformVersionString_$self_blackBerryVersion$$.$userAgent_$, /(?:Linux|CrOS) ([^;)]+)/, 1)) {
    for(var $genericVersion_iVersion_linuxOrCrOsVersion_parts$$3_winPhoneVersion$$ = $genericVersion_iVersion_linuxOrCrOsVersion_parts$$3_winPhoneVersion$$.split(/\s/), $i$$8$$ = 0;$i$$8$$ < $genericVersion_iVersion_linuxOrCrOsVersion_parts$$3_winPhoneVersion$$.length;$i$$8$$ += 1) {
      if(/^[\d\._]+$/.test($genericVersion_iVersion_linuxOrCrOsVersion_parts$$3_winPhoneVersion$$[$i$$8$$])) {
        return $genericVersion_iVersion_linuxOrCrOsVersion_parts$$3_winPhoneVersion$$[$i$$8$$]
      }
    }
  }
...
$webfont$CssClassName$$.prototype.$build$ = function $$webfont$CssClassName$$$$$build$$($var_args$$30$$) {
  for(var $parts$$4$$ = [], $i$$9$$ = 0;$i$$9$$ < arguments.length;$i$$9$$++) {
    $parts$$4$$.push(arguments[$i$$9$$].replace(/[\W_]+/g, "").toLowerCase())
  }
...
function $JSCompiler_StaticMethods_setFont$$($JSCompiler_StaticMethods_setFont$self$$, $font$$3$$) {
  var $JSCompiler_inline_result$$179_quoted$$inline_182$$;
  $JSCompiler_inline_result$$179_quoted$$inline_182$$ = [];
  for(var $split$$inline_183_style$$inline_188$$ = $font$$3$$.$name_$.split(/,\s*/), $i$$inline_184_weight$$inline_189$$ = 0;$i$$inline_184_weight$$inline_189$$ < $split$$inline_183_style$$inline_188$$.length;$i$$inline_184_weight$$inline_189$$++) {
    var $part$$inline_185$$ = $split$$inline_183_style$$inline_188$$[$i$$inline_184_weight$$inline_189$$].replace(/['"]/g, "");
    -1 == $part$$inline_185$$.indexOf(" ") ? $JSCompiler_inline_result$$179_quoted$$inline_182$$.push($part$$inline_185$$) : $JSCompiler_inline_result$$179_quoted$$inline_182$$.push("'" + $part$$inline_185$$ + "'")
  }
  $JSCompiler_inline_result$$179_quoted$$inline_182$$ = $JSCompiler_inline_result$$179_quoted$$inline_182$$.join(",");
  $split$$inline_183_style$$inline_188$$ = "normal";
  $i$$inline_184_weight$$inline_189$$ = $font$$3$$.$weight_$ + "00";
  "o" === $font$$3$$.$style_$ ? $split$$inline_183_style$$inline_188$$ = "oblique" : "i" === $font$$3$$.$style_$ && ($split$$inline_183_style$$inline_188$$ = "italic");
  $JSCompiler_StaticMethods_setFont$self$$.$el_$.style.cssText = "display:block;position:absolute;top:-999px;left:-999px;font-size:300px;width:auto;height:auto;line-height:normal;margin:0;padding:0;font-variant:normal;white-space:nowrap;font-family:" + $JSCompiler_inline_result$$179_quoted$$inline_182$$ + ";" + ("font-style:" + $split$$inline_183_style$$inline_188$$ + ";font-weight:" + $i$$inline_184_weight$$inline_189$$ + ";")
}
...
function $JSCompiler_StaticMethods_watchFonts$$($JSCompiler_StaticMethods_watchFonts$self$$, $fonts$$, $fontTestStrings$$, $metricCompatibleFonts$$, $i$$11_last$$) {
  if(0 === $fonts$$.length && $i$$11_last$$) {
    ...
    $i$$11_last$$ && ($JSCompiler_StaticMethods_watchFonts$self$$.$last_$ = $i$$11_last$$);
    for($i$$11_last$$ = 0;$i$$11_last$$ < $fonts$$.length;$i$$11_last$$++) {
      var $font$$8$$ = $fonts$$[$i$$11_last$$], $fontTestString$$1$$ = $fontTestStrings$$[$font$$8$$.getName()], $JSCompiler_StaticMethods_dispatchFontLoading$self$$inline_119$$ = $JSCompiler_StaticMethods_watchFonts$self$$.$eventDispatcher_$, $font$$inline_120$$ = $font$$8$$;
      $JSCompiler_StaticMethods_updateClassName$$($JSCompiler_StaticMethods_dispatchFontLoading$self$$inline_119$$.$htmlElement_$, [$JSCompiler_StaticMethods_dispatchFontLoading$self$$inline_119$$.$cssClassName_$.$build$($JSCompiler_StaticMethods_dispatchFontLoading$self$$inline_119$$.$namespace_$, $font$$inline_120$$.getName(), $JSCompiler_StaticMethods_getVariation$$($font$$inline_120$$).toString(), "loading")]);
...
$webfont$FontWatcher$$.prototype.$fontActive_$ = function $$webfont$FontWatcher$$$$$fontActive_$$($font$$9$$) {
  ...
  $JSCompiler_StaticMethods_updateClassName$$($JSCompiler_StaticMethods_dispatchFontActive$self$$inline_122$$.$htmlElement_$, [$JSCompiler_StaticMethods_dispatchFontActive$self$$inline_122$$.$cssClassName_$.$build$($JSCompiler_StaticMethods_dispatchFontActive$self$$inline_122$$.$namespace_$, $font$$9$$.getName(), $JSCompiler_StaticMethods_getVariation$$($font$$9$$).toString(), "active")], [$JSCompiler_StaticMethods_dispatchFontActive$self$$inline_122$$.$cssClassName_$.$build$($JSCompiler_StaticMethods_dispatchFontActive$self$$inline_122$$.$namespace_$, 
  $font$$9$$.getName(), $JSCompiler_StaticMethods_getVariation$$($font$$9$$).toString(), "loading"), $JSCompiler_StaticMethods_dispatchFontActive$self$$inline_122$$.$cssClassName_$.$build$($JSCompiler_StaticMethods_dispatchFontActive$self$$inline_122$$.$namespace_$, $font$$9$$.getName(), $JSCompiler_StaticMethods_getVariation$$($font$$9$$).toString(), "inactive")]);
...
$webfont$FontWatcher$$.prototype.$fontInactive_$ = function $$webfont$FontWatcher$$$$$fontInactive_$$($font$$10$$) {
  var $JSCompiler_StaticMethods_dispatchFontInactive$self$$inline_125$$ = this.$eventDispatcher_$, $hasFontActive$$inline_127$$ = $JSCompiler_StaticMethods_hasClassName$$($JSCompiler_StaticMethods_dispatchFontInactive$self$$inline_125$$.$htmlElement_$, $JSCompiler_StaticMethods_dispatchFontInactive$self$$inline_125$$.$cssClassName_$.$build$($JSCompiler_StaticMethods_dispatchFontInactive$self$$inline_125$$.$namespace_$, $font$$10$$.getName(), $JSCompiler_StaticMethods_getVariation$$($font$$10$$).toString(), 
  "active")), $add$$inline_128$$ = [], $remove$$inline_129$$ = [$JSCompiler_StaticMethods_dispatchFontInactive$self$$inline_125$$.$cssClassName_$.$build$($JSCompiler_StaticMethods_dispatchFontInactive$self$$inline_125$$.$namespace_$, $font$$10$$.getName(), $JSCompiler_StaticMethods_getVariation$$($font$$10$$).toString(), "loading")];
  $hasFontActive$$inline_127$$ || $add$$inline_128$$.push($JSCompiler_StaticMethods_dispatchFontInactive$self$$inline_125$$.$cssClassName_$.$build$($JSCompiler_StaticMethods_dispatchFontInactive$self$$inline_125$$.$namespace_$, $font$$10$$.getName(), $JSCompiler_StaticMethods_getVariation$$($font$$10$$).toString(), "inactive"));
  $JSCompiler_StaticMethods_updateClassName$$($JSCompiler_StaticMethods_dispatchFontInactive$self$$inline_125$$.$htmlElement_$, $add$$inline_128$$, $remove$$inline_129$$);
  $JSCompiler_StaticMethods_dispatch_$$($JSCompiler_StaticMethods_dispatchFontInactive$self$$inline_125$$, "fontinactive", $font$$10$$);
  $JSCompiler_StaticMethods_decreaseCurrentlyWatched_$$(this)
};
function $JSCompiler_StaticMethods_decreaseCurrentlyWatched_$$($JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$) {
  0 == --$JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$.$currentlyWatched_$ && $JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$.$last_$ && ($JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$.$success_$ ? ($JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$ = 
  $JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$.$eventDispatcher_$, $JSCompiler_StaticMethods_updateClassName$$($JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$.$htmlElement_$, [$JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$.$cssClassName_$.$build$($JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$.$namespace_$, 
  "active")], [$JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$.$cssClassName_$.$build$($JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$.$namespace_$, "loading"), $JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$.$cssClassName_$.$build$($JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$.$namespace_$, 
  "inactive")]), $JSCompiler_StaticMethods_dispatch_$$($JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$, "active")) : $JSCompiler_StaticMethods_dispatchInactive$$($JSCompiler_StaticMethods_decreaseCurrentlyWatched_$self_JSCompiler_StaticMethods_dispatchActive$self$$inline_131$$.$eventDispatcher_$))
}
;
// Input 14
...
$webfont$WebFont$$.prototype.load = function $$webfont$WebFont$$$$load$($configuration$$1_fontWatcher$$inline_142$$) {
  var $context_eventDispatcher$$inline_138$$ = $configuration$$1_fontWatcher$$inline_142$$.context || this.$mainWindow_$;
  this.$domHelper_$ = new $webfont$DomHelper$$(this.$mainWindow_$, $context_eventDispatcher$$inline_138$$);
  var $context_eventDispatcher$$inline_138$$ = new $webfont$EventDispatcher$$(this.$domHelper_$, $context_eventDispatcher$$inline_138$$.document.documentElement, $configuration$$1_fontWatcher$$inline_142$$), $JSCompiler_StaticMethods_getModules$self$$inline_193_modules$$inline_140$$ = [], $len$$inline_144_timeout$$inline_141$$ = $configuration$$1_fontWatcher$$inline_142$$.timeout;
  $JSCompiler_StaticMethods_updateClassName$$($context_eventDispatcher$$inline_138$$.$htmlElement_$, [$context_eventDispatcher$$inline_138$$.$cssClassName_$.$build$($context_eventDispatcher$$inline_138$$.$namespace_$, "loading")]);
  $JSCompiler_StaticMethods_dispatch_$$($context_eventDispatcher$$inline_138$$, "loading");
  var $JSCompiler_StaticMethods_getModules$self$$inline_193_modules$$inline_140$$ = this.$fontModuleLoader_$, $domHelper$$inline_195_module$$inline_145$$ = this.$domHelper_$, $modules$$inline_196$$ = [], $i$$inline_143_key$$inline_197$$;
  for($i$$inline_143_key$$inline_197$$ in $configuration$$1_fontWatcher$$inline_142$$) {
    if($configuration$$1_fontWatcher$$inline_142$$.hasOwnProperty($i$$inline_143_key$$inline_197$$)) {
      var $moduleFactory$$inline_198$$ = $JSCompiler_StaticMethods_getModules$self$$inline_193_modules$$inline_140$$.$modules_$[$i$$inline_143_key$$inline_197$$];
      $moduleFactory$$inline_198$$ && $modules$$inline_196$$.push($moduleFactory$$inline_198$$($configuration$$1_fontWatcher$$inline_142$$[$i$$inline_143_key$$inline_197$$], $domHelper$$inline_195_module$$inline_145$$))
    }
  }
  $JSCompiler_StaticMethods_getModules$self$$inline_193_modules$$inline_140$$ = $modules$$inline_196$$;
  this.$moduleFailedLoading_$ = this.$moduleLoading_$ = $JSCompiler_StaticMethods_getModules$self$$inline_193_modules$$inline_140$$.length;
  $configuration$$1_fontWatcher$$inline_142$$ = new $webfont$FontWatcher$$(this.$userAgent_$, this.$domHelper_$, $context_eventDispatcher$$inline_138$$, $len$$inline_144_timeout$$inline_141$$);
  $i$$inline_143_key$$inline_197$$ = 0;
  for($len$$inline_144_timeout$$inline_141$$ = $JSCompiler_StaticMethods_getModules$self$$inline_193_modules$$inline_140$$.length;$i$$inline_143_key$$inline_197$$ < $len$$inline_144_timeout$$inline_141$$;$i$$inline_143_key$$inline_197$$++) {
    $domHelper$$inline_195_module$$inline_145$$ = $JSCompiler_StaticMethods_getModules$self$$inline_193_modules$$inline_140$$[$i$$inline_143_key$$inline_197$$], $domHelper$$inline_195_module$$inline_145$$.$supportUserAgent$(this.$userAgent_$, $goog$bind$$(this.$isModuleSupportingUserAgent_$, this, $domHelper$$inline_195_module$$inline_145$$, $context_eventDispatcher$$inline_138$$, $configuration$$1_fontWatcher$$inline_142$$))
  }
};
$webfont$WebFont$$.prototype.$isModuleSupportingUserAgent_$ = function $$webfont$WebFont$$$$$isModuleSupportingUserAgent_$$($allModulesLoaded_module$$, $eventDispatcher$$2$$, $fontWatcher$$, $support$$1$$) {
  ...
  $support$$1$$ ? $allModulesLoaded_module$$.load(function($fonts$$1$$, $opt_fontTestStrings$$, $opt_metricCompatibleFonts$$1$$) {
    var $allModulesLoaded$$inline_152$$ = 0 == --$that$$1$$.$moduleLoading_$;
    setTimeout(function() {
      $JSCompiler_StaticMethods_watchFonts$$($fontWatcher$$, $fonts$$1$$, $opt_fontTestStrings$$ || {}, $opt_metricCompatibleFonts$$1$$ || $JSCompiler_alias_NULL$$, $allModulesLoaded$$inline_152$$)
    }, 0)
...
// Input 15
function $webfont$modules$Fontdeck$$($domHelper$$5$$, $configuration$$3$$) {
...
$webfont$modules$Fontdeck$$.prototype.$supportUserAgent$ = function $$webfont$modules$Fontdeck$$$$$supportUserAgent$$($userAgent$$3$$, $support$$2$$) {
  ...
  $projectId$$1$$ ? ($loadWindow$$.__webfontfontdeckmodule__ || ($loadWindow$$.__webfontfontdeckmodule__ = {}), $loadWindow$$.__webfontfontdeckmodule__[$projectId$$1$$] = function $$loadWindow$$$__webfontfontdeckmodule__$$projectId$$1$$$($fontdeckSupports$$, $data$$21$$) {
    for(var $i$$13$$ = 0, $j$$2$$ = $data$$21$$.fonts.length;$i$$13$$ < $j$$2$$;++$i$$13$$) {
      var $font$$11$$ = $data$$21$$.fonts[$i$$13$$];
    ...
    $support$$2$$($fontdeckSupports$$)
  }, $JSCompiler_StaticMethods_loadScript$$(this.$domHelper_$, this.$getScriptSrc$($projectId$$1$$), function($err$$) {
    $err$$ && $support$$2$$($JSCompiler_alias_FALSE$$)
  })) : $support$$2$$($JSCompiler_alias_FALSE$$)
};
$webfont$modules$Fontdeck$$.prototype.load = function $$webfont$modules$Fontdeck$$$$load$($onReady$$1$$) {
  $onReady$$1$$(this.$fonts_$)
};
// Input 16
function $webfont$modules$Typekit$$($domHelper$$6$$, $configuration$$4$$) {
...
$webfont$modules$Typekit$$.prototype.$supportUserAgent$ = function $$webfont$modules$Typekit$$$$$supportUserAgent$$($userAgent$$4$$, $support$$3$$) {
  var $kitId$$1$$ = this.$configuration_$.id, $configuration$$5$$ = this.$configuration_$, $loadWindow$$1$$ = this.$domHelper_$.$loadWindow_$, $self$$3$$ = this;
  $kitId$$1$$ ? ($loadWindow$$1$$.__webfonttypekitmodule__ || ($loadWindow$$1$$.__webfonttypekitmodule__ = {}), $loadWindow$$1$$.__webfonttypekitmodule__[$kitId$$1$$] = function $$loadWindow$$1$$$__webfonttypekitmodule__$$kitId$$1$$$($callback$$35$$) {
    $callback$$35$$($userAgent$$4$$, $configuration$$5$$, function($typekitSupports$$, $fontFamilies$$, $fontVariations$$) {
      for(var $i$$14$$ = 0;$i$$14$$ < $fontFamilies$$.length;$i$$14$$ += 1) {
        var $variations$$ = $fontVariations$$[$fontFamilies$$[$i$$14$$]];
        if($variations$$) {
          for(var $j$$3$$ = 0;$j$$3$$ < $variations$$.length;$j$$3$$ += 1) {
            $self$$3$$.$fonts_$.push(new $webfont$Font$$($fontFamilies$$[$i$$14$$], $variations$$[$j$$3$$]))
          }
        }else {
          $self$$3$$.$fonts_$.push(new $webfont$Font$$($fontFamilies$$[$i$$14$$]))
        }
      }
      $support$$3$$($typekitSupports$$)
    })
  }, $JSCompiler_StaticMethods_loadScript$$(this.$domHelper_$, this.$getScriptSrc$($kitId$$1$$), function($err$$1$$) {
    $err$$1$$ && $support$$3$$($JSCompiler_alias_FALSE$$)
  }, 2E3)) : $support$$3$$($JSCompiler_alias_FALSE$$)
};
$webfont$modules$Typekit$$.prototype.load = function $$webfont$modules$Typekit$$$$load$($onReady$$2$$) {
...
$webfont$modules$Custom$$.prototype.load = function $$webfont$modules$Custom$$$$load$($onReady$$3$$) {
  var $i$$15$$, $len$$2$$, $fonts$$3_urls$$ = this.$configuration_$.urls || [], $familiesConfiguration$$ = this.$configuration_$.families || [], $fontTestStrings$$1$$ = this.$configuration_$.testStrings || {};
  $i$$15$$ = 0;
  for($len$$2$$ = $fonts$$3_urls$$.length;$i$$15$$ < $len$$2$$;$i$$15$$++) {
    $JSCompiler_StaticMethods_loadStylesheet$$(this.$domHelper_$, $fonts$$3_urls$$[$i$$15$$])
  }
  $fonts$$3_urls$$ = [];
  $i$$15$$ = 0;
  for($len$$2$$ = $familiesConfiguration$$.length;$i$$15$$ < $len$$2$$;$i$$15$$++) {
    var $components$$ = $familiesConfiguration$$[$i$$15$$].split(":");
    if($components$$[1]) {
      for(var $variations$$1$$ = $components$$[1].split(","), $j$$4$$ = 0;$j$$4$$ < $variations$$1$$.length;$j$$4$$ += 1) {
        $fonts$$3_urls$$.push(new $webfont$Font$$($components$$[0], $variations$$1$$[$j$$4$$]))
      }
    }else {
      $fonts$$3_urls$$.push(new $webfont$Font$$($components$$[0]))
    }
  }
  $onReady$$3$$($fonts$$3_urls$$, $fontTestStrings$$1$$)
};
$webfont$modules$Custom$$.prototype.$supportUserAgent$ = function $$webfont$modules$Custom$$$$$supportUserAgent$$($userAgent$$5$$, $support$$4$$) {
  return $support$$4$$($userAgent$$5$$.$browserInfo_$.$webfontSupport_$)
};
// Input 18
function $webfont$modules$google$FontApiUrlBuilder$$($apiUrl$$, $protocol$$4$$, $text$$8$$) {
  this.$apiUrl_$ = $apiUrl$$ ? $apiUrl$$ : $protocol$$4$$ + $webfont$modules$google$FontApiUrlBuilder$DEFAULT_API_URL$$;
  this.$fontFamilies_$ = [];
  this.$subsets_$ = [];
  this.$text_$ = $text$$8$$ || ""
}
...
// Input 19
function $webfont$modules$google$FontApiParser$$($fontFamilies$$3$$) {
  this.$fontFamilies_$ = $fontFamilies$$3$$;
  this.$parsedFonts_$ = [];
...
$webfont$modules$google$FontApiParser$$.prototype.parse = function $$webfont$modules$google$FontApiParser$$$$parse$() {
  for(var $length$$15$$ = this.$fontFamilies_$.length, $i$$18$$ = 0;$i$$18$$ < $length$$15$$;$i$$18$$++) {
    var $elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$ = this.$fontFamilies_$[$i$$18$$].split(":"), $fontFamily$$ = $elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$[0].replace(/\+/g, " "), $variations$$2$$ = ["n4"];
    if(2 <= $elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$.length) {
      var $finalSubsets$$inline_163_finalVariations$$inline_156_fvds$$;
      var $providedVariations$$inline_157_variations$$inline_155$$ = $elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$[1];
      ...
      if($providedVariations$$inline_157_variations$$inline_155$$) {
        for(var $providedVariations$$inline_157_variations$$inline_155$$ = $providedVariations$$inline_157_variations$$inline_155$$.split(","), $length$$inline_158$$ = $providedVariations$$inline_157_variations$$inline_155$$.length, $i$$inline_159$$ = 0;$i$$inline_159$$ < $length$$inline_158$$;$i$$inline_159$$++) {
          var $fvd$$inline_160_groups$$inline_201_variation$$inline_200$$;
          $fvd$$inline_160_groups$$inline_201_variation$$inline_200$$ = $providedVariations$$inline_157_variations$$inline_155$$[$i$$inline_159$$];
          if($fvd$$inline_160_groups$$inline_201_variation$$inline_200$$.match(/^[\w-]+$/)) {
            $fvd$$inline_160_groups$$inline_201_variation$$inline_200$$ = $webfont$modules$google$FontApiParser$VARIATION_MATCH$$.exec($fvd$$inline_160_groups$$inline_201_variation$$inline_200$$.toLowerCase());
            var $JSCompiler_inline_result$$inline_203_JSCompiler_temp$$inline_202_parsedWeight$$inline_204$$ = void 0;
            if($fvd$$inline_160_groups$$inline_201_variation$$inline_200$$ == $JSCompiler_alias_NULL$$) {
              $JSCompiler_inline_result$$inline_203_JSCompiler_temp$$inline_202_parsedWeight$$inline_204$$ = ""
            }else {
              $JSCompiler_inline_result$$inline_203_JSCompiler_temp$$inline_202_parsedWeight$$inline_204$$ = void 0;
              $JSCompiler_inline_result$$inline_203_JSCompiler_temp$$inline_202_parsedWeight$$inline_204$$ = $fvd$$inline_160_groups$$inline_201_variation$$inline_200$$[1];
              if($JSCompiler_inline_result$$inline_203_JSCompiler_temp$$inline_202_parsedWeight$$inline_204$$ == $JSCompiler_alias_NULL$$ || "" == $JSCompiler_inline_result$$inline_203_JSCompiler_temp$$inline_202_parsedWeight$$inline_204$$) {
                $JSCompiler_inline_result$$inline_203_JSCompiler_temp$$inline_202_parsedWeight$$inline_204$$ = "4"
              }else {
                var $weight$$inline_205$$ = $webfont$modules$google$FontApiParser$WEIGHTS$$[$JSCompiler_inline_result$$inline_203_JSCompiler_temp$$inline_202_parsedWeight$$inline_204$$], $JSCompiler_inline_result$$inline_203_JSCompiler_temp$$inline_202_parsedWeight$$inline_204$$ = $weight$$inline_205$$ ? $weight$$inline_205$$ : isNaN($JSCompiler_inline_result$$inline_203_JSCompiler_temp$$inline_202_parsedWeight$$inline_204$$) ? "4" : $JSCompiler_inline_result$$inline_203_JSCompiler_temp$$inline_202_parsedWeight$$inline_204$$.substr(0, 
                1)
              }
              $JSCompiler_inline_result$$inline_203_JSCompiler_temp$$inline_202_parsedWeight$$inline_204$$ = [$fvd$$inline_160_groups$$inline_201_variation$$inline_200$$[2] == $JSCompiler_alias_NULL$$ || "" == $fvd$$inline_160_groups$$inline_201_variation$$inline_200$$[2] ? "n" : $webfont$modules$google$FontApiParser$STYLES$$[$fvd$$inline_160_groups$$inline_201_variation$$inline_200$$[2]], $JSCompiler_inline_result$$inline_203_JSCompiler_temp$$inline_202_parsedWeight$$inline_204$$].join("")
            }
            $fvd$$inline_160_groups$$inline_201_variation$$inline_200$$ = $JSCompiler_inline_result$$inline_203_JSCompiler_temp$$inline_202_parsedWeight$$inline_204$$
          }else {
            $fvd$$inline_160_groups$$inline_201_variation$$inline_200$$ = ""
          }
          $fvd$$inline_160_groups$$inline_201_variation$$inline_200$$ && $finalSubsets$$inline_163_finalVariations$$inline_156_fvds$$.push($fvd$$inline_160_groups$$inline_201_variation$$inline_200$$)
        }
      }
      0 < $finalSubsets$$inline_163_finalVariations$$inline_156_fvds$$.length && ($variations$$2$$ = $finalSubsets$$inline_163_finalVariations$$inline_156_fvds$$);
      3 == $elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$.length && ($elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$ = $elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$[2], $finalSubsets$$inline_163_finalVariations$$inline_156_fvds$$ = [], $elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$ = !$elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$ ? 
      $finalSubsets$$inline_163_finalVariations$$inline_156_fvds$$ : $elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$.split(","), 0 < $elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$.length && ($elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$ = $webfont$modules$google$FontApiParser$INT_FONTS$$[$elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$[0]]) && (this.$fontTestStrings_$[$fontFamily$$] = 
      $elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$))
    }
    this.$fontTestStrings_$[$fontFamily$$] || ($elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$ = $webfont$modules$google$FontApiParser$INT_FONTS$$[$fontFamily$$]) && (this.$fontTestStrings_$[$fontFamily$$] = $elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$);
    for($elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$ = 0;$elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$ < $variations$$2$$.length;$elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$ += 1) {
      this.$parsedFonts_$.push(new $webfont$Font$$($fontFamily$$, $variations$$2$$[$elements$$1_fontTestString$$2_hanumanTestString_j$$5_subsets_subsets$$inline_162$$]))
    }
  }
};
// Input 20
...
$webfont$modules$google$GoogleFontApi$$.prototype.$supportUserAgent$ = function $$webfont$modules$google$GoogleFontApi$$$$$supportUserAgent$$($userAgent$$6$$, $support$$5$$) {
  $support$$5$$($userAgent$$6$$.$browserInfo_$.$webfontSupport_$)
};
$webfont$modules$google$GoogleFontApi$$.prototype.load = function $$webfont$modules$google$GoogleFontApi$$$$load$($onReady$$4$$) {
  var $domHelper$$9$$ = this.$domHelper_$;
  if("MSIE" == this.$userAgent_$.getName() && this.$configuration_$.blocking != $JSCompiler_alias_TRUE$$) {
    var $callback$$inline_169$$ = $goog$bind$$(this.$insertLink_$, this, $onReady$$4$$), $check$$inline_171$$ = function $$check$$inline_171$$$() {
      $domHelper$$9$$.$document_$.body ? $callback$$inline_169$$() : setTimeout($check$$inline_171$$, 0)
    };
    $check$$inline_171$$()
  }else {
    this.$insertLink_$($onReady$$4$$)
  }
};
$webfont$modules$google$GoogleFontApi$$.prototype.$insertLink_$ = function $$webfont$modules$google$GoogleFontApi$$$$$insertLink_$$($onReady$$5$$) {
  for(var $domHelper$$10$$ = this.$domHelper_$, $fontApiUrlBuilder$$ = new $webfont$modules$google$FontApiUrlBuilder$$(this.$configuration_$.api, $JSCompiler_StaticMethods_getProtocol$$($domHelper$$10$$), this.$configuration_$.text), $fontApiParser_fontFamilies$$4$$ = this.$configuration_$.families, $length$$inline_210$$ = $fontApiParser_fontFamilies$$4$$.length, $i$$inline_211$$ = 0;$i$$inline_211$$ < $length$$inline_210$$;$i$$inline_211$$++) {
    var $elements$$inline_212$$ = $fontApiParser_fontFamilies$$4$$[$i$$inline_211$$].split(":");
    3 == $elements$$inline_212$$.length && $fontApiUrlBuilder$$.$subsets_$.push($elements$$inline_212$$.pop());
    var $joinCharacter$$inline_213$$ = "";
    2 == $elements$$inline_212$$.length && "" != $elements$$inline_212$$[1] && ($joinCharacter$$inline_213$$ = ":");
    $fontApiUrlBuilder$$.$fontFamilies_$.push($elements$$inline_212$$.join($joinCharacter$$inline_213$$))
  }
  $fontApiParser_fontFamilies$$4$$ = new $webfont$modules$google$FontApiParser$$($fontApiParser_fontFamilies$$4$$);
  $fontApiParser_fontFamilies$$4$$.parse();
  $JSCompiler_StaticMethods_loadStylesheet$$($domHelper$$10$$, $fontApiUrlBuilder$$.$build$());
  $onReady$$5$$($fontApiParser_fontFamilies$$4$$.$parsedFonts_$, $fontApiParser_fontFamilies$$4$$.$fontTestStrings_$, $webfont$modules$google$GoogleFontApi$METRICS_COMPATIBLE_FONTS$$)
};
// Input 21
function $webfont$modules$Monotype$$($domHelper$$11$$, $configuration$$8$$) {
  this.$domHelper_$ = $domHelper$$11$$;
  this.$configuration_$ = $configuration$$8$$;
  this.$fonts_$ = []
}
$webfont$modules$Monotype$$.prototype.$supportUserAgent$ = function $$webfont$modules$Monotype$$$$$supportUserAgent$$($userAgent$$7$$, $support$$6$$) {
  var $self$$4$$ = this, $projectId$$2$$ = $self$$4$$.$configuration_$.projectId, $version$$16$$ = $self$$4$$.$configuration_$.version;
  if($projectId$$2$$) {
    var $loadWindow$$2$$ = $self$$4$$.$domHelper_$.$loadWindow_$;
    $JSCompiler_StaticMethods_loadScript$$(this.$domHelper_$, $self$$4$$.$getScriptSrc$($projectId$$2$$, $version$$16$$), function($err$$2_mti_fnts$$inline_176$$) {
      if($err$$2_mti_fnts$$inline_176$$) {
        $support$$6$$($JSCompiler_alias_FALSE$$)
      }else {
        if($loadWindow$$2$$["__mti_fntLst" + $projectId$$2$$] && ($err$$2_mti_fnts$$inline_176$$ = $loadWindow$$2$$["__mti_fntLst" + $projectId$$2$$]())) {
          for(var $i$$inline_177$$ = 0;$i$$inline_177$$ < $err$$2_mti_fnts$$inline_176$$.length;$i$$inline_177$$++) {
            $self$$4$$.$fonts_$.push(new $webfont$Font$$($err$$2_mti_fnts$$inline_176$$[$i$$inline_177$$].fontfamily))
          }
        }
        $support$$6$$($userAgent$$7$$.$browserInfo_$.$webfontSupport_$)
      }
