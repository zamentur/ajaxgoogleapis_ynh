...
function $JSCompiler_StaticMethods_setFont$$($JSCompiler_StaticMethods_setFont$self$$, $font$$3$$) {
  var $JSCompiler_inline_result$$177_quoted$$inline_180$$;
  $JSCompiler_inline_result$$177_quoted$$inline_180$$ = [];
  for(var $split$$inline_181_style$$inline_186$$ = $font$$3$$.$name_$.split(/,\s*/), $i$$inline_182_weight$$inline_187$$ = 0;$i$$inline_182_weight$$inline_187$$ < $split$$inline_181_style$$inline_186$$.length;$i$$inline_182_weight$$inline_187$$++) {
    var $part$$inline_183$$ = $split$$inline_181_style$$inline_186$$[$i$$inline_182_weight$$inline_187$$].replace(/['"]/g, "");
    -1 == $part$$inline_183$$.indexOf(" ") ? $JSCompiler_inline_result$$177_quoted$$inline_180$$.push($part$$inline_183$$) : $JSCompiler_inline_result$$177_quoted$$inline_180$$.push("'" + $part$$inline_183$$ + "'")
  }
  $JSCompiler_inline_result$$177_quoted$$inline_180$$ = $JSCompiler_inline_result$$177_quoted$$inline_180$$.join(",");
  $split$$inline_181_style$$inline_186$$ = "normal";
  $i$$inline_182_weight$$inline_187$$ = $font$$3$$.$weight_$ + "00";
  "o" === $font$$3$$.$style_$ ? $split$$inline_181_style$$inline_186$$ = "oblique" : "i" === $font$$3$$.$style_$ && ($split$$inline_181_style$$inline_186$$ = "italic");
  $JSCompiler_StaticMethods_setFont$self$$.$el_$.style.cssText = "position:absolute;top:-999px;left:-999px;font-size:300px;width:auto;height:auto;line-height:normal;margin:0;padding:0;font-variant:normal;white-space:nowrap;font-family:" + $JSCompiler_inline_result$$177_quoted$$inline_180$$ + ";" + ("font-style:" + $split$$inline_181_style$$inline_186$$ + ";font-weight:" + $i$$inline_182_weight$$inline_187$$ + ";")
}
...
$webfont$WebFont$$.prototype.load = function $$webfont$WebFont$$$$load$($configuration$$1_fontWatcher$$inline_139_timeout$$inline_138$$) {
  var $context_eventDispatcher$$inline_135$$ = $configuration$$1_fontWatcher$$inline_139_timeout$$inline_138$$.context || this.$mainWindow_$;
  this.$domHelper_$ = new $webfont$DomHelper$$(this.$mainWindow_$, $context_eventDispatcher$$inline_135$$);
  var $context_eventDispatcher$$inline_135$$ = new $webfont$EventDispatcher$$(this.$domHelper_$, $context_eventDispatcher$$inline_135$$.document.documentElement, $configuration$$1_fontWatcher$$inline_139_timeout$$inline_138$$), $JSCompiler_StaticMethods_getModules$self$$inline_189_len$$inline_141$$ = this.$fontModuleLoader_$, $domHelper$$inline_191_module$$inline_142$$ = this.$domHelper_$, $modules$$inline_192$$ = [], $i$$inline_140_key$$inline_193$$;
  for($i$$inline_140_key$$inline_193$$ in $configuration$$1_fontWatcher$$inline_139_timeout$$inline_138$$) {
    if($configuration$$1_fontWatcher$$inline_139_timeout$$inline_138$$.hasOwnProperty($i$$inline_140_key$$inline_193$$)) {
      var $moduleFactory$$inline_194$$ = $JSCompiler_StaticMethods_getModules$self$$inline_189_len$$inline_141$$.$modules_$[$i$$inline_140_key$$inline_193$$];
      $moduleFactory$$inline_194$$ && $modules$$inline_192$$.push($moduleFactory$$inline_194$$($configuration$$1_fontWatcher$$inline_139_timeout$$inline_138$$[$i$$inline_140_key$$inline_193$$], $domHelper$$inline_191_module$$inline_142$$))
    }
  }
  ...
  this.$moduleFailedLoading_$ = this.$moduleLoading_$ = $modules$$inline_192$$.length;
  $configuration$$1_fontWatcher$$inline_139_timeout$$inline_138$$ = new $webfont$FontWatcher$$(this.$userAgent_$, this.$domHelper_$, $context_eventDispatcher$$inline_135$$, $configuration$$1_fontWatcher$$inline_139_timeout$$inline_138$$);
  $i$$inline_140_key$$inline_193$$ = 0;
  for($JSCompiler_StaticMethods_getModules$self$$inline_189_len$$inline_141$$ = $modules$$inline_192$$.length;$i$$inline_140_key$$inline_193$$ < $JSCompiler_StaticMethods_getModules$self$$inline_189_len$$inline_141$$;$i$$inline_140_key$$inline_193$$++) {
    $domHelper$$inline_191_module$$inline_142$$ = $modules$$inline_192$$[$i$$inline_140_key$$inline_193$$], $domHelper$$inline_191_module$$inline_142$$.$supportUserAgent$(this.$userAgent_$, $goog$bind$$(this.$isModuleSupportingUserAgent_$, this, $domHelper$$inline_191_module$$inline_142$$, $context_eventDispatcher$$inline_135$$, $configuration$$1_fontWatcher$$inline_139_timeout$$inline_138$$))
  }
};
...
// Input 15
function $webfont$modules$Monotype$$($domHelper$$5$$, $configuration$$3$$) {
  this.$domHelper_$ = $domHelper$$5$$;
  this.$configuration_$ = $configuration$$3$$;
  this.$fonts_$ = []
}
$webfont$modules$Monotype$$.prototype.$supportUserAgent$ = function $$webfont$modules$Monotype$$$$$supportUserAgent$$($userAgent$$3$$, $support$$2$$) {
  ...
  if($projectId$$) {
    ...
    $JSCompiler_StaticMethods_loadScript$$(this.$domHelper_$, $self$$2$$.$getScriptSrc$($projectId$$, $version$$16$$), function($err_mti_fnts$$inline_152$$) {
      if($err_mti_fnts$$inline_152$$) {
        $support$$2$$($JSCompiler_alias_FALSE$$)
      }else {
        if($loadWindow$$["__mti_fntLst" + $projectId$$] && ($err_mti_fnts$$inline_152$$ = $loadWindow$$["__mti_fntLst" + $projectId$$]())) {
          for(var $i$$inline_153$$ = 0;$i$$inline_153$$ < $err_mti_fnts$$inline_152$$.length;$i$$inline_153$$++) {
            $self$$2$$.$fonts_$.push(new $webfont$Font$$($err_mti_fnts$$inline_152$$[$i$$inline_153$$].fontfamily))
          }
        }
...
// Input 16
function $webfont$modules$Fontdeck$$($domHelper$$6$$, $configuration$$4$$) {
...
$webfont$modules$Fontdeck$$.prototype.$supportUserAgent$ = function $$webfont$modules$Fontdeck$$$$$supportUserAgent$$($userAgent$$4$$, $support$$3$$) {
  var $projectId$$3$$ = this.$configuration_$.id, $loadWindow$$1$$ = this.$domHelper_$.$loadWindow_$, $self$$3$$ = this;
  $projectId$$3$$ ? ($loadWindow$$1$$.__webfontfontdeckmodule__ || ($loadWindow$$1$$.__webfontfontdeckmodule__ = {}), $loadWindow$$1$$.__webfontfontdeckmodule__[$projectId$$3$$] = function $$loadWindow$$1$$$__webfontfontdeckmodule__$$projectId$$3$$$($fontdeckSupports$$, $data$$21$$) {
  ...
  }, $JSCompiler_StaticMethods_loadScript$$(this.$domHelper_$, this.$getScriptSrc$($projectId$$3$$), function($err$$1$$) {
...
$webfont$modules$google$FontApiParser$$.prototype.parse = function $$webfont$modules$google$FontApiParser$$$$parse$() {
  for(var $length$$15$$ = this.$fontFamilies_$.length, $i$$18$$ = 0;$i$$18$$ < $length$$15$$;$i$$18$$++) {
    var $elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$ = this.$fontFamilies_$[$i$$18$$].split(":"), $fontFamily$$ = $elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$[0].replace(/\+/g, " "), $variations$$ = ["n4"];
    if(2 <= $elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$.length) {
      var $finalSubsets$$inline_164_finalVariations$$inline_157_fvds$$;
      var $providedVariations$$inline_158_variations$$inline_156$$ = $elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$[1];
      $finalSubsets$$inline_164_finalVariations$$inline_157_fvds$$ = [];
      if($providedVariations$$inline_158_variations$$inline_156$$) {
        for(var $providedVariations$$inline_158_variations$$inline_156$$ = $providedVariations$$inline_158_variations$$inline_156$$.split(","), $length$$inline_159$$ = $providedVariations$$inline_158_variations$$inline_156$$.length, $i$$inline_160$$ = 0;$i$$inline_160$$ < $length$$inline_159$$;$i$$inline_160$$++) {
          var $fvd$$inline_161_groups$$inline_197_variation$$inline_196$$;
          $fvd$$inline_161_groups$$inline_197_variation$$inline_196$$ = $providedVariations$$inline_158_variations$$inline_156$$[$i$$inline_160$$];
          if($fvd$$inline_161_groups$$inline_197_variation$$inline_196$$.match(/^[\w]+$/)) {
            $fvd$$inline_161_groups$$inline_197_variation$$inline_196$$ = $webfont$modules$google$FontApiParser$VARIATION_MATCH$$.exec($fvd$$inline_161_groups$$inline_197_variation$$inline_196$$.toLowerCase());
            var $JSCompiler_inline_result$$inline_199_JSCompiler_temp$$inline_198_parsedWeight$$inline_200$$ = void 0;
            if($fvd$$inline_161_groups$$inline_197_variation$$inline_196$$ == $JSCompiler_alias_NULL$$) {
              $JSCompiler_inline_result$$inline_199_JSCompiler_temp$$inline_198_parsedWeight$$inline_200$$ = ""
            }else {
              $JSCompiler_inline_result$$inline_199_JSCompiler_temp$$inline_198_parsedWeight$$inline_200$$ = void 0;
              $JSCompiler_inline_result$$inline_199_JSCompiler_temp$$inline_198_parsedWeight$$inline_200$$ = $fvd$$inline_161_groups$$inline_197_variation$$inline_196$$[1];
              if($JSCompiler_inline_result$$inline_199_JSCompiler_temp$$inline_198_parsedWeight$$inline_200$$ == $JSCompiler_alias_NULL$$ || "" == $JSCompiler_inline_result$$inline_199_JSCompiler_temp$$inline_198_parsedWeight$$inline_200$$) {
                $JSCompiler_inline_result$$inline_199_JSCompiler_temp$$inline_198_parsedWeight$$inline_200$$ = "4"
              }else {
                var $weight$$inline_201$$ = $webfont$modules$google$FontApiParser$WEIGHTS$$[$JSCompiler_inline_result$$inline_199_JSCompiler_temp$$inline_198_parsedWeight$$inline_200$$], $JSCompiler_inline_result$$inline_199_JSCompiler_temp$$inline_198_parsedWeight$$inline_200$$ = $weight$$inline_201$$ ? $weight$$inline_201$$ : isNaN($JSCompiler_inline_result$$inline_199_JSCompiler_temp$$inline_198_parsedWeight$$inline_200$$) ? "4" : $JSCompiler_inline_result$$inline_199_JSCompiler_temp$$inline_198_parsedWeight$$inline_200$$.substr(0, 
                1)
              }
              $JSCompiler_inline_result$$inline_199_JSCompiler_temp$$inline_198_parsedWeight$$inline_200$$ = [$fvd$$inline_161_groups$$inline_197_variation$$inline_196$$[2] == $JSCompiler_alias_NULL$$ || "" == $fvd$$inline_161_groups$$inline_197_variation$$inline_196$$[2] ? "n" : $webfont$modules$google$FontApiParser$STYLES$$[$fvd$$inline_161_groups$$inline_197_variation$$inline_196$$[2]], $JSCompiler_inline_result$$inline_199_JSCompiler_temp$$inline_198_parsedWeight$$inline_200$$].join("")
            }
            $fvd$$inline_161_groups$$inline_197_variation$$inline_196$$ = $JSCompiler_inline_result$$inline_199_JSCompiler_temp$$inline_198_parsedWeight$$inline_200$$
          }else {
            $fvd$$inline_161_groups$$inline_197_variation$$inline_196$$ = ""
          }
          $fvd$$inline_161_groups$$inline_197_variation$$inline_196$$ && $finalSubsets$$inline_164_finalVariations$$inline_157_fvds$$.push($fvd$$inline_161_groups$$inline_197_variation$$inline_196$$)
        }
      }
      0 < $finalSubsets$$inline_164_finalVariations$$inline_157_fvds$$.length && ($variations$$ = $finalSubsets$$inline_164_finalVariations$$inline_157_fvds$$);
      3 == $elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$.length && ($elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$ = $elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$[2], $finalSubsets$$inline_164_finalVariations$$inline_157_fvds$$ = [], $elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$ = !$elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$ ? 
      $finalSubsets$$inline_164_finalVariations$$inline_157_fvds$$ : $elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$.split(","), 0 < $elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$.length && ($elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$ = $webfont$modules$google$FontApiParser$INT_FONTS$$[$elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$[0]]) && (this.$fontTestStrings_$[$fontFamily$$] = 
      $elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$))
    }
    this.$fontTestStrings_$[$fontFamily$$] || ($elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$ = $webfont$modules$google$FontApiParser$INT_FONTS$$[$fontFamily$$]) && (this.$fontTestStrings_$[$fontFamily$$] = $elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$);
    for($elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$ = 0;$elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$ < $variations$$.length;$elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$ += 1) {
      this.$parsedFonts_$.push(new $webfont$Font$$($fontFamily$$, $variations$$[$elements$$1_fontTestString$$2_hanumanTestString_j$$2_subsets_subsets$$inline_163$$]))
    }
  }
};
// Input 19
...
$webfont$modules$google$GoogleFontApi$$.prototype.load = function $$webfont$modules$google$GoogleFontApi$$$$load$($onReady$$3$$) {
  ...
  if("MSIE" == this.$userAgent_$.getName() && this.$configuration_$.blocking != $JSCompiler_alias_TRUE$$) {
    var $callback$$inline_170$$ = $goog$bind$$(this.$insertLink_$, this, $onReady$$3$$), $check$$inline_172$$ = function $$check$$inline_172$$$() {
      $domHelper$$8$$.$document_$.body ? $callback$$inline_170$$() : setTimeout($check$$inline_172$$, 0)
    };
    $check$$inline_172$$()
  }else {
...
$webfont$modules$google$GoogleFontApi$$.prototype.$insertLink_$ = function $$webfont$modules$google$GoogleFontApi$$$$$insertLink_$$($onReady$$4$$) {
  for(var $domHelper$$9$$ = this.$domHelper_$, $fontApiUrlBuilder$$ = new $webfont$modules$google$FontApiUrlBuilder$$(this.$configuration_$.api, $JSCompiler_StaticMethods_getProtocol$$($domHelper$$9$$), this.$configuration_$.text), $fontApiParser_fontFamilies$$3$$ = this.$configuration_$.families, $length$$inline_206$$ = $fontApiParser_fontFamilies$$3$$.length, $i$$inline_207$$ = 0;$i$$inline_207$$ < $length$$inline_206$$;$i$$inline_207$$++) {
    var $elements$$inline_208$$ = $fontApiParser_fontFamilies$$3$$[$i$$inline_207$$].split(":");
    3 == $elements$$inline_208$$.length && $fontApiUrlBuilder$$.$subsets_$.push($elements$$inline_208$$.pop());
    var $joinCharacter$$inline_209$$ = "";
    2 == $elements$$inline_208$$.length && "" != $elements$$inline_208$$[1] && ($joinCharacter$$inline_209$$ = ":");
    $fontApiUrlBuilder$$.$fontFamilies_$.push($elements$$inline_208$$.join($joinCharacter$$inline_209$$))
  }
...
$webfont$modules$Typekit$$.prototype.$getScriptSrc$ = function $$webfont$modules$Typekit$$$$$getScriptSrc$$($kitId$$) {
  var $protocol$$4$$ = $JSCompiler_StaticMethods_getProtocol$$(this.$domHelper_$);
  return(this.$configuration_$.api || $protocol$$4$$ + "//use.typekit.net") + "/" + $kitId$$ + ".js"
};
$webfont$modules$Typekit$$.prototype.$supportUserAgent$ = function $$webfont$modules$Typekit$$$$$supportUserAgent$$($userAgent$$6$$, $support$$5$$) {
  var $kitId$$1$$ = this.$configuration_$.id, $configuration$$7$$ = this.$configuration_$, $loadWindow$$2$$ = this.$domHelper_$.$loadWindow_$, $self$$4$$ = this;
  $kitId$$1$$ ? ($loadWindow$$2$$.__webfonttypekitmodule__ || ($loadWindow$$2$$.__webfonttypekitmodule__ = {}), $loadWindow$$2$$.__webfonttypekitmodule__[$kitId$$1$$] = function $$loadWindow$$2$$$__webfonttypekitmodule__$$kitId$$1$$$($callback$$35$$) {
    $callback$$35$$($userAgent$$6$$, $configuration$$7$$, function($typekitSupports$$, $fontFamilies$$4$$, $fontVariations$$) {
      for(var $i$$20$$ = 0;$i$$20$$ < $fontFamilies$$4$$.length;$i$$20$$ += 1) {
        var $variations$$2$$ = $fontVariations$$[$fontFamilies$$4$$[$i$$20$$]];
        if($variations$$2$$) {
          for(var $j$$3$$ = 0;$j$$3$$ < $variations$$2$$.length;$j$$3$$ += 1) {
            $self$$4$$.$fonts_$.push(new $webfont$Font$$($fontFamilies$$4$$[$i$$20$$], $variations$$2$$[$j$$3$$]))
          }
        }else {
          $self$$4$$.$fonts_$.push(new $webfont$Font$$($fontFamilies$$4$$[$i$$20$$]))
        }
      }
      $support$$5$$($typekitSupports$$)
    })
  }, $JSCompiler_StaticMethods_loadScript$$(this.$domHelper_$, this.$getScriptSrc$($kitId$$1$$), function($err$$2$$) {
    $err$$2$$ && $support$$5$$($JSCompiler_alias_FALSE$$)
...
// Input 21
function $webfont$modules$Custom$$($domHelper$$11$$, $configuration$$8$$) {
...
$webfont$modules$Custom$$.prototype.load = function $$webfont$modules$Custom$$$$load$($onReady$$6$$) {
  var $i$$21$$, $len$$4$$, $fonts$$3_urls$$ = this.$configuration_$.urls || [], $familiesConfiguration$$ = this.$configuration_$.families || [], $fontTestStrings$$1$$ = this.$configuration_$.testStrings || {};
  $i$$21$$ = 0;
  for($len$$4$$ = $fonts$$3_urls$$.length;$i$$21$$ < $len$$4$$;$i$$21$$++) {
    $JSCompiler_StaticMethods_loadStylesheet$$(this.$domHelper_$, $fonts$$3_urls$$[$i$$21$$])
  }
  $fonts$$3_urls$$ = [];
  $i$$21$$ = 0;
  for($len$$4$$ = $familiesConfiguration$$.length;$i$$21$$ < $len$$4$$;$i$$21$$++) {
    var $components$$ = $familiesConfiguration$$[$i$$21$$].split(":");
    if($components$$[1]) {
      for(var $variations$$3$$ = $components$$[1].split(","), $j$$4$$ = 0;$j$$4$$ < $variations$$3$$.length;$j$$4$$ += 1) {
        $fonts$$3_urls$$.push(new $webfont$Font$$($components$$[0], $variations$$3$$[$j$$4$$]))
      }
    }else {
      $fonts$$3_urls$$.push(new $webfont$Font$$($components$$[0]))
    }
  }
  $onReady$$6$$($fonts$$3_urls$$, $fontTestStrings$$1$$)
};
